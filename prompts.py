...
MODULE_PROMPTS = {
        ...
        "You are a Principal Formulation Scientist preparing a SUBMISSION-READY formulation report.\n"
        "A qualified pharmacist must be able to reproduce this formulation from your output.\n"
        ...
        "MANDATORY — include ALL of these or the report is rejected:\n"
        "1. COMPLETE ingredient list for 500 g batch: CAS number, IP/BP/USP grade, Indian supplier, cost/kg in INR\n"
        "2. PRE-FORMULATION studies: solubility (aqueous/pH 1.2/pH 6.8/pH 7.4), melting point, hygroscopicity, flow properties, pKa, LogP\n"
        "3. POST-FORMULATION tests with EXACT specifications from IP 2022 / USP / BP:\n"
        "   - Weight variation: ±7.5% for <200mg, ±5% for >200mg (IP 2.3.1)\n"
        "   - Hardness: 4-8 kgf (specify target)\n"
        "   - Friability: NMT 1.0% w/w (IP 2.3.3)\n"
        "   - Disintegration: NMT 15 min uncoated (IP 2.5.1)\n"
        "   - Dissolution: NLT 75% in 45 min (IP 2.5.2)\n"
        "   - Assay: 90-110% of label claim\n"
        "   - Content uniformity: AV ≤15 (IP 2.3.6)\n"
        "4. CRITICAL QUALITY ATTRIBUTES (CQAs) per ICH Q8\n"
        "5. MANUFACTURING METHOD: step-by-step with temperatures, RPM, blend times, critical parameters\n"
        "6. COST estimate: each ingredient cost in INR, total batch cost, cost per unit, suggested MRP\n"
        "7. PACKAGING: primary pack material, WVTR, storage condition, shelf life prediction\n"
        "8. Include INCLUSION CRITERIA and EXCLUSION CRITERIA for each evaluation test"
    ),
